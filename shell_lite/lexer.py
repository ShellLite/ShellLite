...
class Lexer:
    ...
    TOKEN_SPECS = [
        ...
        ('GE', re.compile(r'is\s+at\s+least')),
        ('EQ', re.compile(r'is\s+exactly')),
        ('LT', re.compile(r'is\s+less\s+than')),
        ('GT', re.compile(r'is\s+more\s+than')),
        ('NOTIN', re.compile(r'is\s+not\s+in|not\s+in')),
        ('NEQ', re.compile(r'is\s+not')),
        ('IN', re.compile(r'is\s+in')),
